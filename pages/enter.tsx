...
export default function Enter() {
  ...
  return (
    <div className="mt-16 px-4">
      <h3 className="text-center text-3xl font-bold">이졉마켓</h3>
      <div className="mt-8">
        ...
        <form className="mt-8 flex flex-col">
          ...
          <div className="mt-1">
            {method === "email" ? (
              <input
                type="email"
                className="w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-b-orange-500 focus:ring-orange-500"
                required
              />
            ) : null}
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                ...
                <input
                  type="number"
                  className="w-full appearance-none rounded-md rounded-l-none border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-b-orange-500 focus:ring-orange-500"
                  required
                />
              </div>
            ) : null}
